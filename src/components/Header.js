...
class Header extends React.Component {
    constructor(props) {
      ...
      this.state = {
        ...
        dataFetched: false,
        origin: "",
        restapiEndpoint: global_restapiEndpointSecure,
    ...
    componentDidUpdate(){
      ...
      if(mdlLayoutDrawerButton){
        ...
        componentHandler.downgradeElements(mdlJsLayout);
        try{
    ...
    handleSelectChange(page,origin,json,sortmethod,sortby) {
      var page = (arguments[0] != null) ? arguments[0] : 1;
      var origin = (arguments[1] != null) ? arguments[1] : "";
      var json = (arguments[2] != null) ? arguments[2] : "";
      var sortmethod = (arguments[3] != null) ? arguments[3] : this.state.sortmethod;
    ...
    toggleEndpoints(type) {
      this.setState({
        restapiEndpoint: type === "secure" ? global_restapiEndpointSecure : global_restapiEndpointInsecure,
    ...
    render() {
      var posts = this.state.posts.map(
        function (post, index) {
          ...
          return (
            <NavLink className="mdl-navigation__link" to={link}>
              {post.title}
            </NavLink>
          );
        }.bind(this)
